...
const ExchangeDesiredItemTypeOfItemScreen = () => {
  ...
  useEffect(() => {
    const getStoredType = async () => {
      try {
        const storedType = await AsyncStorage.getItem("selectedExchangeDesiredItemType");
        if (storedType) {
  ...
  const handleSelectType = async (type: string) => {
    try {
      await AsyncStorage.setItem("selectedExchangeDesiredItemType", type);
...
export default ExchangeDesiredItemTypeOfItemScreen;
