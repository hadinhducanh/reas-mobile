...
const ExchangeDetail: React.FC = () => {
  ...
  return (
    <SafeAreaView className="flex-1 bg-[#f6f9f9]">
      <View className="relative flex-row items-center justify-center h-[60px] border-b-[1px] border-gray-200">
        <Text className="text-[18px] font-bold">Exchange detail</Text>
        <Pressable
      ...
      <ScrollView className="px-5">
        <View className="flex-row items-center justify-between pt-3 ">
          <View className="flex-row ">
            <Text className="text-gray-500 text-base">Exchange ID:&nbsp;</Text>
            <Text className="text-gray-500 font-bold text-base">#EX12356</Text>
          </View>
        ...
        <View>
          <View className="flex-row justify-between">
            <Text className="font-bold text-lg text-gray-500">Their item</Text>
        ...
        <View className="mt-8">
          ...
          <View className="bg-white mt-2 rounded-lg p-4 flex-row justify-between h-fit">
            ...
            <View className="w-1/2 justify-between">
              ...
              <View className="flex-row items-center justify-end">
                <Icon name="calendar-clear-outline" size={20} color="#00B0B9" />
        ...
        <View className="mt-8">
          ...
          <View className="bg-white mt-2 rounded-lg p-4 flex-col justify-center h-fit">
            <View className="flex-row items-center">
              ...
              <Text className="text-base text-gray-500">Không đổi trả lại</Text>
            </View>
        ...
        <View className="my-8">
          ...
          <View className="bg-white mt-2 rounded-lg p-4 flex-col justify-center h-fit">
            <View className="flex-row items-center justify-between">
              <Text className="text-base text-gray-800">Their item price</Text>
