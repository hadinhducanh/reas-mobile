    ...
    <SafeAreaView className="flex-1 bg-[#F6F9F9]">
      ...
      <ScrollView className="mx-5" showsVerticalScrollIndicator={false}>
        <View className="py-5">
          ...
          <View className="rounded-md p-3 flex-row items-center bg-white shadow-xl">
        ...
        <View className="mt-8">
          ...
          <View className="bg-white mt-2 rounded-lg p-4 flex-row justify-between shadow-md">
        ...
        <View className="my-5">
          ...
          <View className=" p-5 rounded-lg my-2 bg-white">
