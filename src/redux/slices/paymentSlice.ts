...
function setCheckoutUrl(
    ...
    .addCase(createPaymentLinkThunk.fulfilled, (state, action: PayloadAction<CheckoutResponseData>) => {
        state.loadingPayment = false;
        state.checkoutUrl = action.payload.checkoutUrl;
    })
    .addCase(createPaymentLinkThunk.rejected, (state, action: PayloadAction<any>) => {
        state.loadingPayment = false;
