...
const BrandSelectionUpdateScreen = () => {
  const navigation =
  ...
  if (
    ...
    selectedBrandId = updateItem.desiredItem?.brandId || 0;
    ...
    selectedBrandId = updateItem.brandId;
    handleSelectBrand = (brandId: number, brandName: string) => {
      if (selectedBrandId === brandId) {
        setUpdateItem({ ...updateItem, brandId: 0, brandName: "" });
      } else {
        setUpdateItem({ ...updateItem, brandId, brandName });
      }
      navigation.goBack();
    };
  }
...
export default BrandSelectionUpdateScreen;
